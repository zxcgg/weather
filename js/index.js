$(function() {
	$().ready(function() {
		for(var i = 0; i < city.length; i++) {
			$("#province").append("<option value='" + i + "'>" + city[i].name + "</option>")
		}
	})
	$("#province").change(function() {
		...
		var p = city[$("#province").val()].city.length;
		for(var j = 0; j < p; j++) {
			$("#city").append("<option value='" + j + "'>" + city[$("#province").val()].city[j].name + "</option>")
		}
	...
	$("#city").change(function() {
		...
		var p = city[$("#province").val()].city[$("#city").val()].area.length;
		for(var k = 0; k < p; k++) {
			$("#area").append("<option  >" + city[$("#province").val()].city[$("#city").val()].area[k] + "</option>")
		}
	...
	function show(name) {
		...
		$.ajax({
			type: "get",
			url: "http://www.sojson.com/open/api/weather/json.shtml?city=" + name,
			async: true,
			dataType: "json",
			success: function(data) {
				if(data.status != 200) {
					$("#ts").addClass("label label-danger show")
					sleep();
					return false;
				}
				null1(name, data);
		...
		function null1(name, data) {
			$("#city").append(name)
			$("#page").append("<tr ><th>" + "昨天" + "</th> <th>" + data.data.yesterday.high + "</th> <th>" + data.data.yesterday.low + "</th> <th>" + data.data.yesterday.fl + "</th> <th>" + data.data.yesterday.fx + "</th> <th>" + data.data.yesterday.type + "</th> </tr>")
			for(var i = 0; i < data.data.forecast.length; i++) {
				$("#page").append("<tr ><th>" + data.data.forecast[i].date + "</th> <th>" + data.data.forecast[i].high + "</th> <th>" + data.data.forecast[i].low + "</th> <th>" + data.data.forecast[i].fengli + "</th> <th>" + data.data.forecast[i].fengxiang + "</th> <th>" + data.data.forecast[i].fengxiang + "</th> </tr>")
			}
			$("#title").append("<tr ><th>日期</th> <th>高温</th> <th>低温</th> <th>风力</th> <th>风向</th> <th>天气</th> </tr>")
			sleep();
